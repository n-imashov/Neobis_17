...
from rest_framework.test import APITestCase
from courses.models import Recipe, Category, Contact, Branch
...
class TestCourseDetailView(APITestCase):
    ...
    def create_course(self):
        course = Recipe.objects.create(name='CodeMind',
...
class TestCourseModels(APITestCase):
    def test_create_course(self):
        course = Recipe.objects.create(name='course', description='description', logo='logo')
        self.assertIsInstance(course, Recipe)
